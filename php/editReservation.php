...
<form method="POST" action="updateEditReservation.php" name=editres onsubmit="return validate(this)">
	<table >
        <tr>
        ...
        <tr>
	        ...
	        <td><input type="text" name="contact" value=<?php echo $contact ?> required pattern=[0-9]{10}></td>
        </tr>
        <tr>
        ...
        <tr>
	        ...
	        <td><input type=text value=<?php echo $address; ?> <?php if($pid>12){echo "required"; }?>></td>
        </tr>
        <tr>
        ...
        <tr>
	        ...
	        <td><input type="text" name="rstatus" value='<?php echo $rstatus ?>' readonly></td>
        </tr>
        <tr>
            <td><label class=contentName>Number Of Guests</label></td>
	        <td><input type="text" name="guests" value=<?php echo $guests ?> pattern=[0-9]{0,3}></td>
        </tr>
        <tr>
